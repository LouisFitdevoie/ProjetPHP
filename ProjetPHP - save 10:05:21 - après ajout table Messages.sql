...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 10 mai 2021 à 13:46
...
(16, 1, 5, 'Très bon film', 5, '2021-05-03 17:37:17'),
...
INSERT INTO `Messages` (`messageId`, `content`, `date`, `auteurId`, `destinataireId`) VALUES
(11, 'Bonjour', '2021-05-10 15:44:28', 14, 1),
(12, 'Bonjour', '2021-05-10 15:44:41', 1, 14);
...
--
ALTER TABLE `Films`
  MODIFY `filmId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
